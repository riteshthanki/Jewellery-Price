      ...
      <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-slate-900 aspect-video md:aspect-[21/9]">
        {media.map((item, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent flex items-end justify-center pb-8 md:pb-12">
              {item.title && (
                <h3 className="text-white text-2xl md:text-4xl font-serif font-bold tracking-wider drop-shadow-lg transform transition-transform duration-700 translate-y-0 opacity-100">
                  {item.title}
                </h3>
              )}
            </div>
